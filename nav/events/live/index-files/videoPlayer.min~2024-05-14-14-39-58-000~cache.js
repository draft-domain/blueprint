...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return loadVideoPlayerContent; });
...
/* harmony import */ var ramsey_jwplayer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ramsey-jwplayer */ "../../../../node_modules/ramsey-jwplayer/dist/js/Player.js");
/* harmony import */ var ramsey_jwplayer__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(ramsey_jwplayer__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _functions_documentReady__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../functions/documentReady */ "./js/functions/documentReady.js");




function initializeJwplayer(player) {
  var jwplayer = player.querySelector('[data-jwplayer]');
  var jwPlayerSelector = "[data-gazelle-id=\"".concat(player.dataset.gazelleId, "\"] [data-jwplayer]");
  if (jwplayer) {
    var jwPlayerConfig = {
      ...
      cast: {},
      playlist: [{
        file: jwplayer.dataset.file,
        starttime: parseInt(jwplayer.dataset.startTime, 10)
      }]
    };
    ramsey_jwplayer__WEBPACK_IMPORTED_MODULE_2__["VideoPlayer"].initialize(jwPlayerConfig, jwPlayerSelector);
  }
}
function loadVideoPlayerContent(event) {
  var player = event.currentTarget;
  var customThumbnail = player.querySelector('.VideoPlayer-customThumbnail');
  customThumbnail.classList.add('VideoPlayer-customThumbnail--transparent');
  player.removeEventListener('click', loadVideoPlayerContent);
  initializeJwplayer(player);
}
function initializeVideoPlayers() {
  var videoPlayers = document.querySelectorAll('[data-video-provider]');
  videoPlayers.forEach(function (player) {
    player.addEventListener('click', loadVideoPlayerContent);
  });
}
Object(_functions_documentReady__WEBPACK_IMPORTED_MODULE_3__["default"])(function () {
  return initializeVideoPlayers();
});
...
/***/ "./sass/components/videoPlayer/videoPlayer.scss":
/*!******************************************************!*\
  !*** ./sass/components/videoPlayer/videoPlayer.scss ***!
  \******************************************************/
/*! no static exports found */
...
/***/ 29:
/*!*******************************************************************************************!*\
  !*** multi ./js/components/videoPlayer.js ./sass/components/videoPlayer/videoPlayer.scss ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./js/components/videoPlayer.js */"./js/components/videoPlayer.js");
module.exports = __webpack_require__(/*! ./sass/components/videoPlayer/videoPlayer.scss */"./sass/components/videoPlayer/videoPlayer.scss");
